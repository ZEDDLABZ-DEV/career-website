        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-success-gold to-yellow-500 flex items-center justify-center">
                <svg className="w-7 h-7 text-authority" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a key={idx} href="#" className="w-10 h-10 rounded-xl glass-card flex items-center justify-center hover:bg-white/20 transition-all group">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Take Assessment', '133 Careers', 'Salary Tracker', 'School Partners', 'For Counselors'].map((link, idx) => (
                <li key={idx}>
